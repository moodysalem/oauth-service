...
public class QueryHelper {
    ...
    public static CallLog logCall(EntityManager em, Client client, ContainerRequestContext request) {
        return logCall(em, client, null, request);
    }

    public static CallLog logCall(EntityManager em, Application application, ContainerRequestContext request) {
     ...
     */
    private static CallLog logCall(EntityManager em, Client client, Application application, ContainerRequestContext request) {
        ...
        String forwardedIp = request.getHeaderString("X-Forwaded-For");
        if (forwardedIp != null) {
