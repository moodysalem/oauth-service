/*1447892631,,JIT Construction: v2051151,en_US*/
...
try {
  window.FB || (function (window) {
    ...
    var global = { __type: 'JS_SDK_SANDBOX' };
    ...
    (function () {
      ...
      with (this) {
        ...
        __d("JSSDKRuntimeConfig", [], { "locale": "en_US", "rtl": false, "revision": "2051151" });
        __d("JSSDKConfig", [], {
          "bustCache": true,
        ...
        __d('sdk.Impressions', [ 'sdk.Content', 'Miny', 'QueryString', 'sdk.Runtime', 'UrlMap', 'getBlankIframeSrc', 'guid', 'insertIframe' ], function a(b, c, d, e, f, g, h, i, j, k, l, m, n, o) {
          ...
          function p(r) {
            ...
            if (u.length <= 2000) {
              ...
              o({
                url: m(), root: y, name: x, className: 'fb_hidden fb_invisible', onload: function () {
        ...
        __d('URISchemes', [ 'createObjectFrom' ], function a(b, c, d, e, f, g, h) {
          if (c.__markCompiled)c.__markCompiled();
          var i = h([ 'fb', 'fb-ama', 'fb-messenger', 'fbcf', 'fbconnect', 'fbmobilehome', 'fbrpc', 'file', 'ftp', 'http', 'https', 'mailto', 'ms-app', 'intent', 'itms', 'itms-apps', 'itms-services', 'market', 'svn+ssh', 'fbstaging', 'tel', 'sms', 'pebblejs', 'sftp' ]), j = {
        ...
        __d('sdk.RPC', [ 'Assert', 'JSONRPC', 'Queue' ], function a(b, c, d, e, f, g, h, i, j) {
          ...
          var k = new j(), l = new i(function (n) {
            ...
            local: l.local, remote: l.remote, stub: ES(l.stub, 'bind', true, l), setInQueue: function (n) {
              h.isInstanceOf(j, n);
              n.start(function (o) {
                l.read(o);
              });
        ...
        __d('sdk.XD', [ 'sdk.Content', 'sdk.Event', 'Log', 'QueryString', 'Queue', 'sdk.RPC', 'sdk.Runtime', 'sdk.Scribe', 'sdk.URI', 'UrlMap', 'JSSDKXDConfig', 'XDM', 'isFacebookURI', 'sdk.createIframe', 'sdk.feature', 'guid' ], function a(b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v, w) {
          ...
          function sa(ua) {
            if (ka)return;
            var va = h.appendHidden(document.createElement('div')), wa = s.create({
              blacklist: null,
              root: va,
              channel: ha,
          ...
          i.subscribe('init:post', function (ua) {
            ...
            if (va)setTimeout(function () {
              ...
              if (!wa)o.log('jssdk_error', {
                ...
                extra: { message: 'Failed to initialize in ' + va + 'ms' }
              });
            }, va);
          });
          f.exports = ta;
        ...
        __d('sdk.Auth', [ 'sdk.Cookie', 'sdk.createIframe', 'DOMWrapper', 'sdk.feature', 'sdk.getContextType', 'guid', 'sdk.Impressions', 'Log', 'ObservableMixin', 'sdk.Runtime', 'sdk.SignedRequest', 'UrlMap', 'sdk.URI', 'sdk.XD' ], function a(b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u) {
          ...
          function aa(ea, fa, ga) {
            return function (ha) {
              ...
              if (ha && ha.access_token) {
                ...
                if (q.getUseCookie()) {
                  var ka = fa.expiresIn === 0 ? 0 : ES('Date', 'now', false) + fa.expiresIn * 1000, la = h.getDomain();
          ...
          function ba(ea) {
            ...
            var ha = aa(ea, v, 'login_status'), ia = new t(s.resolve('www', true) + '/connect/ping').setQueryData({
              ...
              redirect_uri: u.handler(function (ja) {
                if (k('e2e_ping_tracking', true)) {
                  var ka = { init: ga, close: ES('Date', 'now', false), method: 'ping' };
        ...
        __d('sdk.DOM', [ 'Assert', 'sdk.UA', 'createArrayFromMixed', 'sdk.domReady' ], function a(b, c, d, e, f, g, h, i, j, k) {
          ...
          function t(aa, ba, ca) {
            ...
            var da = ba.getElementsByTagName(ca), ea = [];
          ...
          function u(aa, ba) {
            ...
            var ca = aa.currentStyle || document.defaultView.getComputedStyle(aa, null), da = ca[ ba ];
        ...
        __d('CORSRequest', [ 'wrapFunction', 'QueryString' ], function a(b, c, d, e, f, g, h, i) {
          ...
          function k(m, n, o, p) {
            ...
            r.onerror = function (s) {
              if (s.responseText) {
                p(ES('JSON', 'parse', false, s.responseText));
              } else p({ error: { type: 'http', message: 'unknown error', status: s.status } });
            };
            r.send(q);
            return true;
          }
        ...
        __d('ApiClient', [ 'ArgumentError', 'Assert', 'CORSRequest', 'FlashRequest', 'flattenObject', 'JSONPRequest', 'Log', 'ObservableMixin', 'QueryString', 'sprintf', 'sdk.URI', 'UrlMap', 'ApiClientConfig', 'invariant' ], function a(b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u) {
          ...
          function ka(ta, ua, va, wa) {
            ...
            va = l(va);
            var ya = { jsonp: m, cors: j, flash: k }, za;
            if (va.transport) {
              za = [ va.transport ];
              delete va.transport;
            } else za = ba;
            for (var ab = 0; ab < za.length; ab++) {
              var bb = ya[ za[ ab ] ], cb = ES('Object', 'assign', false, {}, va);
              if (bb.execute(ta, ua, cb, wa))return;
            }
            wa({ error: { type: 'no-transport', message: 'Could not find a usable transport for request' } });
          }
          ...
          function ma(ta) {
            ...
            ab.method = ya;
            return { uri: va, callback: za, params: ab };
          }

          function na() {
            for (var ta = arguments.length, ua = Array(ta), va = 0; va < ta; va++)ua[ va ] = arguments[ va ];
            var wa = ma(ua), xa = wa.uri, ya = wa.callback, za = wa.params, ab = za.method;
            if (sa(xa, ab))ab = 'post';
          ...
          function oa() {
            for (var ta = arguments.length, ua = Array(ta), va = 0; va < ta; va++)ua[ va ] = arguments[ va ];
            var wa = ma(ua), xa = wa.uri, ya = wa.callback, za = wa.params.method, ab = {
              method: za,
          ...
          function pa() {
            ...
            ea = null;
            if (ta.length === 1) {
              var va = ta[ 0 ], wa = ua[ 0 ], xa = va.body ? p.decode(va.body) : null;
              na(va.relative_url, va.method, xa, wa);
              return;
            }
            na('/', 'POST', { batch: ta, include_headers: false, batch_app_id: w || ja }, function (ya) {
              if (ES('Array', 'isArray', false, ya)) {
                ...
                return (za({ error: { message: 'Fatal: batch call failed.' } }));
              });
            });
          }
          ...
          function qa(ta, ua) {
            ...
            ta.api_key = w;
            var wa = va in aa ? 'api_read' : 'api', xa = s.resolve(wa) + '/restserver.php', ya = ES(la, 'bind', true, null, ua, '/restserver.php', 'get', ta, ES('Date', 'now', false));
            ka(xa, 'get', ta, ya);
          }
          ...
          var ra = ES('Object', 'assign', false, new o(), {
            setAccessToken: function (ta) {
              ...
              return ga.length;
            }, rest: qa, graph: na, scheduleBatchCall: oa
          });
        ...
        __d('sdk.PlatformVersioning', [ 'sdk.Runtime', 'ManagedError' ], function a(b, c, d, e, f, g, h, i) {
          if (c.__markCompiled)c.__markCompiled();
          var j = /^v\d+\.\d\d?$/, k = {
            REGEX: j, assertVersionIsSet: function () {
        ...
        __d('sdk.Dialog', [ 'sdk.Canvas.Environment', 'sdk.Content', 'sdk.DOM', 'DOMEventListener', 'ObservableMixin', 'sdk.Runtime', 'Type', 'sdk.UA', 'sdk.fbt', 'sdk.feature' ], function a(b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q) {
          ...
          function w() {
            if (q('dialog_resize_refactor', false)) {
              ...
              if (z.height && z.width)return { width: Math.min(z.width, t), height: Math.min(z.height, s) };
            }
            return null;
          }
          ...
          var x = n.extend({
            ...
            _handleOrientationChange: function () {
              ...
              if (y.isTabletStyle()) {
                ...
                for (var ba in y._dialogs)if (y._dialogs.hasOwnProperty(ba)) {
        ...
        __d('sdk.UIServer', [ 'sdk.Auth', 'sdk.Content', 'sdk.DOM', 'sdk.Dialog', 'sdk.Event', 'sdk.Frictionless', 'Log', 'sdk.Native', 'QueryString', 'sdk.RPC', 'sdk.Runtime', 'JSSDKConfig', 'sdk.UA', 'UrlMap', 'sdk.XD', 'createObjectFrom', 'sdk.feature', 'flattenObject', 'sdk.getContextType', 'guid', 'insertIframe', 'resolveURI' ], function a(b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v, w, x, y, z, aa, ba, ca) {
          ...
          var da = {
            ...
            'stream.share': {
              size: { width: 670, height: 340 }, url: 'sharer.php', transform: function (ja) {
            ...
            'permissions.oauth': {
              ...
              transform: function (ja) {
                ...
                if (h.getAuthResponse() && !ja.params.scope && !ja.params.auth_type) {
                  ...
                  ja.cb && ja.cb({ status: r.getLoginStatus(), authResponse: h.getAuthResponse() });
                  return;
                }
                var ka = ja.cb, la = ja.id;
                delete ja.cb;
            ...
            'auth.logout': {
              url: 'logout.php', transform: function (ja) {
                if (!r.getClientID()) {
            ...
            'login.status': {
              url: 'dialog/oauth', transform: function (ja) {
                var ka = ja.cb, la = ja.id;
                delete ja.cb;
                ES('Object', 'assign', false, ja.params, {
                  client_id: r.getClientID(),
          ...
          var ia = {
            ...
            prepareCall: function (ja, ka) {
              var la = ja.method.toLowerCase(), ma = ia.Methods.hasOwnProperty(la) ? ES('Object', 'assign', false, {}, ia.Methods[ la ]) : {}, na = aa(), oa = r.getSecure() || la !== 'auth.status' && la != 'login.status';
              ...
              if (ha(ja)) {
                if (fa[ la ]) {
                  ...
                  n.warn(pa);
                  ka({ error_code: -100, error_message: pa });
                  return;
                }
                ka = ga(ka, la);
              }
              ...
              var sa = ma.getXdRelation || ia.getXdRelation, ta = sa(qa.params);
              if (!(qa.id in ia._defaultCb) && !('next' in qa.params) && !('redirect_uri' in qa.params))qa.params.next = ia._xdResult(qa.cb, qa.id, ta, true);
              if (ta === 'parent')ES('Object', 'assign', false, qa.params, { channel_url: ia._xdChannelHandler(na, 'parent.parent') }, true);
            ...
            popup: function (ja) {
              ...
              if (ja.post) {
                ...
                if (ua) {
                  ...
                  i.submitToTarget({ url: ja.url, target: ja.id, params: ja.params });
                }
              } else {
            ...
            setLoadedNode: function (ja, ka, la) {
              ...
              ka = { node: ka, type: la, fbCallID: ja.id };
              ia._loadedNodes[ ja.id ] = ka;
            },
            getLoadedNode: function (ja) {
              var ka = typeof ja == 'object' ? ja.id : ja, la = ia._loadedNodes[ ka ];
            ...
            _insertIframe: function (ja) {
              ...
              if (ja.post) {
                ba({
                  ...
                  onInsert: ka,
                  onload: function (la) {
                    i.submitToTarget({ url: ja.url, target: la.name, params: ja.params });
                  }
                });
              } else ba({
                url: ja.url,
            ...
            _triggerDefault: function (ja) {
              ia._xdRecv({ frame: ja }, ia._defaultCb[ ja ] || function () {
                });
            },
        ...
        __d('sdk.Canvas.Plugin', [ 'Log', 'sdk.RPC', 'sdk.Runtime', 'sdk.UA', 'sdk.api', 'createArrayFromMixed' ], function a(b, c, d, e, f, g, h, i, j, k, l, m) {
          if (c.__markCompiled)c.__markCompiled();
          var n = 'CLSID:D27CDB6E-AE6D-11CF-96B8-444553540000', o = 'CLSID:444785F1-DE89-4295-863A-D46C3A781394', p = null, q = k.osx() && k.osx.getVersionParts(), r = !(q && q[ 0 ] > 10 && q[ 1 ] > 10 && (k.chrome() >= 31 || k.webkit() >= 537.71 || k.firefox() >= 25));
          ...
          function w(ca) {
            var da = ca.type ? ca.type.toLowerCase() : null, ea = da === 'application/x-shockwave-flash' || ca.classid && ca.classid.toUpperCase() == n;
            if (!ea)return false;
          ...
          function y(ca) {
            ...
            var ea = false, fa = false;
            ES(da, 'forEach', true, function (ha) {
              var ia = w(ha), ja = r && x(ha);
              if (!ia && !ja)return;
              ea = ea || ia;
              fa = fa || ja;
              var ka = function () {
              ...
              if (p) {
                ...
                var la = { state: ca.state, elem: ha };
                p(la);
                setTimeout(ka, 200);
              } else ka();
            });
            if (Math.random() <= 1 / 1000) {
              var ga = { unity: fa, flash: ea };
          ...
          var ba = {
            _setHidePluginCallback: function (ca) {
              p = ca;
            }, hidePluginElement: z, showPluginElement: aa
          };
          f.exports = ba;
        }, null);
        ...
        __d('sdk.Canvas.Prefetcher', [ 'sdk.api', 'createArrayFromMixed', 'JSSDKCanvasPrefetcherConfig', 'sdk.Runtime' ], function a(b, c, d, e, f, g, h, i, j, k) {
          if (c.__markCompiled)c.__markCompiled();
          var l = { AUTOMATIC: 0, MANUAL: 1 }, m = j.sampleRate, n = j.blacklist, o = l.AUTOMATIC, p = [];

          function q() {
            var v = { object: 'data', link: 'href', script: 'src' };
        ...
        __d('XFBML', [ 'Assert', 'sdk.DOM', 'Log', 'ObservableMixin', 'sdk.UA', 'createArrayFromMixed', 'runOnce' ], function a(b, c, d, e, f, g, h, i, j, k, l, m, n) {
          ...
          ES('Object', 'assign', false, r, {
            registerTag: function (z) {
              ...
              y(z || document.body, aa || function () {
                }, true);
            }, parseNew: function () {
              y(document.body, function () {
              }, false);
            }
          });
          f.exports = r;
        ...
        __d('PluginPipe', [ 'sdk.Content', 'sdk.feature', 'guid', 'insertIframe', 'Miny', 'ObservableMixin', 'JSSDKPluginPipeConfig', 'sdk.Runtime', 'sdk.UA', 'UrlMap', 'XFBML' ], function a(b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r) {
          ...
          function x(y) {
            ...
            k({
              url: 'about:blank', root: z, name: ea, className: 'fb_hidden fb_invisible', onload: function () {
            ...
            constructor: function (ia, ja, ka, la) {
              ...
              if (r.mobile()) {
                ...
                if (!this._iframeOptions.width) {
                  ...
                  if (r.iphone() || r.ipad())ES('Object', 'assign', false, ma, { width: '220px', 'min-width': '100%' });
        ...
        __d('PluginTags', [], function a(b, c, d, e, f, g) {
          ...
          var h = {
            ...
            messengerpreconfirmation: { messenger_app_id: 'string' },
            messengeraccountconfirmation: { messenger_app_id: 'string', state: 'string' },
            messengerbusinesslink: { messenger_app_id: 'string', state: 'string' },
            messengertoggle: { messenger_app_id: 'string', token: 'string' },
            messengermessageus: { messenger_app_id: 'string', color: 'string', size: 'string' },
  ...
  new Image().src = "https:\/\/www.facebook.com\/" + 'common/scribe_endpoint.php?c=jssdk_error&m=' + encodeURIComponent('{"error":"LOAD", "extra": {"name":"' + e.name + '","line":"' + (e.lineNumber || e.line) + '","script":"' + (e.fileName || e.sourceURL || e.script) + '","stack":"' + (e.stackTrace || e.stack) + '","revision":"2051151","message":"' + e.message + '"}}');
}