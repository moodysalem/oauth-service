...
(function () {
  ...
  var Xa = decodeURI("%73cript"), Ya = function (a, b) {
    ...
    if (f[ "::" ] && d.length) {
      for (var g = [], k = null; k = d.shift();) {
        ...
        l && l.hint == h || (m = { hint: h, N: [] }, g.push(m));
        m.N.push(k)
      }
      var q = g.length;
      if (1 < q) {
  ...
  var $c = function (a) {
    ...
    d = "E" === c && e.g;
    return !d && ("U" !== c || e.g) || d && !Wc ? b : { O: !0, g: d, da: a.substr(1), domain: e.domain, i: e.i }
  }, ad = function (a) {
    if (!a)return [];
    a = a.split("=");
    ...
    a = a.split(":");
    return {
      D: a[ 0 ].split("=")[ 1 ], ca: ad(a[ 1 ]),
      fa: ad(a[ 2 ]), ea: ad(a[ 3 ])
    }
  }, cd = function () {
    var a = Zc(), b = a.X, a = a.B;
    if (null !== a) {
      var c;
      ...
      if (c) {
        var d = bd(c), e = d && d.ca[ Number(a) ], d = d && d.D;
  ...
  var ed = null, qb = function () {
    ...
    var a = cd(), b = a && a.ba || null, c = a && a.D;
    P("auth", {
      callback: function () {
...
gapi.load("", {
  ...
  _c: {
    "jsl": {
      ...
      "h": "m;/_/scs/apps-static/_/js/k\u003doz.gapi.en.BbFfU_k9Oe8.O/m\u003d__features__/am\u003dEQ/rt\u003dj/d\u003d1/t\u003dzcms/rs\u003dAGLTcCNVmyfvvQgNAH4EHhzcHKUK9hFB_Q",
