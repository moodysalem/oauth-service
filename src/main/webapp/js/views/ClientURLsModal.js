 ...
 *
 */
define([ "react", "rbs", "underscore", "rbs/components/mixins/Model", "rbs/components/layout/Modal", "rbs/components/controls/Button",
    "rbs/components/layout/Alert" ],
  function (React, rbs, _, model, modal, btn, alert) {
    "use strict";
